...
function 'feffery'_antdtreeselect(; kwargs...)
        available_props = Symbol[:id, :allowClear, :bordered, :className, :defaultValue, :listHeight, :loading_state, :maxTagCount, :multiple, :placeholder, :size, :style, :treeCheckStrictly, :treeCheckable, :treeData, :treeDefaultExpandAll, :treeDefaultExpandedKeys, :treeExpandedKeys, :value, :virtual]
        wild_props = Symbol[]

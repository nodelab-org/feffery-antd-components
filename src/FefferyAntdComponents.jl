...
include("jl/'feffery'_antdtypography.jl")
...
function __init__()
    ...
    external_url = "https://unpkg.com/feffery_antd_components@0.0.1a30/feffery_antd_components/feffery_antd_components.min.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_antd_components@0.0.1a30/feffery_antd_components/feffery_antd_components.min.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
